          ...
          <form onSubmit={handleUpdateProfile} className="bg-white shadow-xl shadow-gray-200/50 border border-gray-100 rounded-3xl p-10 space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full px-5 py-4 bg-gray-50 border border-gray-100 rounded-2xl focus:outline-none focus:ring-2 focus:ring-[#7a9c72] font-bold text-gray-900"
            ...
            <div className="pt-6 border-t border-gray-50 flex items-center justify-between">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-xl bg-[#7a9c72]/10 border border-[#7a9c72]/20 flex items-center justify-center shadow-sm overflow-hidden">
                  {profileForm.logo ? (
                    <img src={profileForm.logo} alt="Preview" className="w-full h-full object-cover" />
                  ) : (
                    <span className="text-[#7a9c72] font-black text-xl">{profileForm.name?.charAt(0) || 'A'}</span>
                  )}
                </div>

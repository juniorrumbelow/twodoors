      ...
      <div className="relative mb-10 w-full max-w-3xl mx-auto z-50" ref={dropdownRef}>
        <form onSubmit={handleSearch} className="relative flex items-center justify-center group w-full">
          <input
            ...
            className="w-full pl-6 pr-28 md:px-8 py-5 text-lg font-medium text-gray-900 bg-white border border-gray-200 rounded-full shadow-2xl focus:outline-none focus:border-[#7a9c72] focus:ring-4 focus:ring-[#7a9c72]/20 transition-all placeholder:text-gray-400"
          />
          <button
            type="submit"
            disabled={loading}
            className="absolute right-2 top-2 bottom-2 px-4 md:px-8 bg-[#7a9c72] text-white font-bold rounded-full hover:bg-[#02a97e] transition-all duration-300 shadow-md hover:shadow-lg disabled:opacity-50 disabled:hover:scale-100 flex items-center justify-center gap-2 z-10"
          >
            {loading ? (
              <>
          ...
          <div className="absolute top-full left-0 right-0 mt-3 bg-white border border-gray-100 rounded-3xl shadow-2xl max-h-72 overflow-y-auto animate-in fade-in slide-in-from-top-2 py-3 text-left z-50 ring-1 ring-black/5 custom-scrollbar">
            {filteredSuggestions.map((suggestion, idx) => (
              <button
                key={idx}
                type="button"
                className="w-full px-6 py-3 text-left text-gray-700 hover:bg-[#7a9c72]/10 hover:text-[#7a9c72] font-medium transition-colors cursor-pointer border-b border-gray-50 last:border-0"
                onClick={() => {
              ...
              >
                <span className="flex items-center gap-3">
                  <svg className="w-4 h-4 text-[#7a9c72]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                  {suggestion}
                </span>
              </button>
            ))}
      ...
      {data && (
        <div ref={resultsRef} className="bg-white rounded-[2rem] p-6 md:p-10 shadow-2xl border border-gray-100 text-gray-900 scroll-mt-24">
          <div className="mb-8 flex flex-col md:flex-row md:items-end md:justify-between border-b border-gray-100 pb-6 gap-4">
            <div>
              ...
              <p className="text-gray-500 mt-2 font-medium text-lg flex items-center gap-2">
                <svg className="w-5 h-5 text-[#7a9c72]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-6 py-2.5 rounded-full font-bold text-sm transition-all duration-300 ${copied
                    ...
                    : 'bg-white text-gray-700 border border-gray-200 hover:border-[#7a9c72] hover:text-[#7a9c72] hover:shadow-md'
                    }`}
                >
                  {copied ? (
                    <>
          ...
          {!data.entities || data.entities.length === 0 ? (
            <div className="text-center py-16 text-gray-400 bg-[#f5f1ea] rounded-3xl border border-gray-100">
                    ...
                    >
                      ...
                      <div className="md:w-48 flex-shrink-0 flex flex-row md:flex-col justify-between md:justify-start gap-4 md:border-r md:border-gray-100 md:pr-6">
                        <div className="flex flex-col gap-2">
                          <span className="inline-flex items-center px-3 py-1 bg-[#7a9c72]/10 text-[#7a9c72] text-[10px] font-bold rounded-full uppercase tracking-wider w-fit">
                      ...
                      <div className="flex-grow flex flex-col">
                        <div className="flex flex-col md:flex-row md:items-start justify-between gap-4 mb-4">
                          <div className="flex-grow max-w-4xl">
                            <h3 className="font-extrabold text-lg md:text-xl text-gray-900 mb-2 leading-tight group-hover:text-[#7a9c72] transition-colors line-clamp-3" title={app.notes || app.description || 'No details available'}>
                            ...
                            {(app['address-text'] || app['site-address']) && (
                              <p className="text-gray-500 flex items-center gap-2 text-sm md:text-base font-medium">
                                <svg className="w-4 h-4 flex-shrink-0 text-[#7a9c72]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                                {app['address-text'] || app['site-address']}
                              </p>
                            )}
                          </div>
                        ...
                        <div className="flex flex-wrap items-center gap-3 mt-auto pt-4 border-t border-gray-50">
                          ...
                          {url && (
                            <span
                              className="inline-flex items-center gap-2 px-6 py-2 bg-[#7a9c72] hover:bg-[#02a97e] text-white font-bold text-sm rounded-xl transition-all duration-300 shadow-sm hover:shadow-md md:ml-auto group/btn"
                            >
                              View Details
                ...
                <div className="mt-12 pt-8 border-t border-gray-100 flex flex-col md:flex-row items-center justify-between gap-6">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex items-center gap-1 min-w-[80px] justify-center text-sm font-bold">
                      <span className="text-[#7a9c72]">{currentPage}</span>
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#7a9c72] hover:bg-[#02a97e] disabled:opacity-30 disabled:hover:bg-[#7a9c72] text-white font-bold text-sm rounded-xl transition-all duration-300 shadow-lg"
                    >
                      Next

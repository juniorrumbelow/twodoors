    ...
    <div className="w-full max-w-md p-8 bg-white rounded-3xl border border-gray-100 shadow-2xl text-gray-900 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <form onSubmit={handleEmailAuth} className="space-y-5">
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-4 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#7a9c72] focus:bg-white placeholder-gray-400 text-gray-900 outline-none transition-all font-medium"
            value={email}
        ...
        <button
          ...
          className={`w-full py-4 px-4 rounded-xl font-bold text-lg transition-all shadow-xl outline-none focus:ring-4 ${
            isSigningUp 
              ...
              : 'bg-[#7a9c72] hover:bg-[#5e7d57] text-white shadow-[#7a9c72]/20 focus:ring-[#7a9c72]/50'
          }`}
        >
      ...
      <p className="mt-8 text-center text-sm text-gray-500 font-medium">
        ...
        <button
          ...
          className="text-[#7a9c72] hover:text-[#01a67d] font-bold transition-all px-1"
        >
